...
class signup extends Component {
    ...
    validate = () => {
        let nameError = ""
        let emailError, rePassError, error, businessError = ""
        let passwordError = ""
        ...
        if (!this.state.businessType){
            businessError="*Please fill out this field"
        }
        ...
        if (nameError || passwordError || emailError || rePassError || error || addressError || contactError || businessError) {
            this.setState({ nameError, passwordError, emailError, rePassError, error, addressError, contactError, businessError })
            return false;
        }
        return true
    }
                                    ...
                                    <div class="login_wrap">
                                        <div class="padding_eight_all bg-white">
                                            ...
                                            <form method="post" onSubmit={this.handleSubmit}>
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control" value={this.state.businessType} onChange={this.handleChange} required="" name="businessType" placeholder="BusinessType" />
                                                    <div style={{ color: 'red', fontSize: '12px' }}>{this.state.businessError} </div>
                                                </div>
                                                <div class="form-group">
